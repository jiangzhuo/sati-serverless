...
export class WanderEntity {
  ...
  @Column({ type: "text", default: "" })
  description: string;
  // @ManyToMany(type => SceneEntity, scene => scene.wander, )
  // @JoinTable()
  // scenes: SceneEntity[];
  ...
  // @RelationId((wander: WanderEntity) => wander.sceneEntities)
  // scenes: string[];
  ...
  @Column({ type: "text", default: "" })
  copy: string;
  @ManyToMany(type => WanderAlbumEntity)
  @JoinTable()
  wanderAlbums: WanderAlbumEntity[];
