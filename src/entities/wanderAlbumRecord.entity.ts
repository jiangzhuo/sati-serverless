...
import { WanderAlbumEntity } from './wanderAlbum.entity';

@Entity('wander_album_record')
@Index(['userId', 'wanderAlbumId'], { unique: true })
export class WanderAlbumRecordEntity {
  @PrimaryGeneratedColumn("uuid")
  id: string;
  @ManyToOne(type => UserEntity)
  @JoinColumn({ name: 'userId' })
  userId: UserEntity;
  @ManyToOne(type => WanderAlbumEntity)
  @JoinColumn({ name: 'wanderAlbumId' })
  wanderAlbumId: WanderAlbumEntity;
  @Column({ type: "int" })
